...
tJogo EfetuaResumo (tJogo jogo, char * diretorio, int nMov, char acao) {
    ...
    case 1:
        fprintf(fResumo, "Movimento %d (%c) pegou comida", nMov, acao);
        break;

    case 2:
        fprintf(fResumo, "Movimento %d (%c) colidiu na parede", nMov, acao);
        break;

    case 3:
        fprintf(fResumo, "Movimento %d (%c) fim de jogo por encostar em um fantasma", nMov, acao);
        break;
...
void RealizaJogo(tJogo jogo, char * diretorio) {
    ...
    while (scanf("%c%*c", &acao) == 1) {
        ...
        EfetuaResumo(jogo, diretorio, nMov, acao);
...
// Movimento 6 (d) pegou comida
// Movimento 11 (s) colidiu na parede
// Movimento 13 (s) fim de jogo por encostar em um fantasma
