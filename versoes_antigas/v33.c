...
void RealizaJogo(tJogo jogo, char * diretorio) {
    ...
    while (scanf("%c%*c", &acao) == 1) {
        ...
        // se ele tiver a vida = 0, finaliza o jogo e retorna as estatisticas
        ...
        // finaliza e retorna arquivos se a qtd jogadas realizas for igual a qtd maxima de jogadas permitidas
